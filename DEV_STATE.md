...
继续处理剩余 8 个 `excluded` 企业的官网候选：一汽-大众、东风日产、中国中车、亚马逊中国、广汽丰田、携程、网易、苹果中国。只有官网语义审阅确认没有合格公告时，才接收 wxcli 生成的微信 Candidate Batch。任何新批次仍须完成主要公告四字段证据和岗位投影门控，不得因为来源接口存在而自动展示。
