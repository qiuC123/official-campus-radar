...
Phase and status: Phase 02 / H1 Cycle 01 收到修改意见，静态原型进入 Cycle 02；H1/H2 未确认，因此 G07～G10 不得记为正式接受；H3 尚未开始。
...
- H1：用户确认 Cycle 02 静态原型的公司/行业分类、届次、代表岗位概括方式和视觉方向。
...
先等待用户验收 H1 Cycle 02；若仍有修改意见，新建 Cycle 03。H1 通过后再把本轮原型决策同步到 Django 预览页并进行 H2，随后才能依序接受 G07～G10。全程不自动访问任何企业网站。
