...
- H3：企业类型配额已确认（民企 20、央国企 10、外资 6、银行 5、中外合资 4、事业单位 3、社会机构 2，共 50 家）；公开官网及官网直链第三方系统的只读、低并发访问范围已确认，不设固定开页次数上限，禁止登录、投递和绕过风控；50 家必须全部留证，至少 25 家达到可稳定接入标准。具体企业名单待确认。H3 完成前禁止启动 T3 企业外网探测。
