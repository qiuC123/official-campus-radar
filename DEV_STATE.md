...
Phase and status: Phase 02 / H1、H2、G10 已通过；当前停在 H3。首批 50 家企业的七类配额和公开只读访问范围已由用户确认，具体名单和最低成功线仍待确认；T3 尚未开始。
...
- H3：企业类型配额已确认（民企 20、央国企 10、外资 6、银行 5、中外合资 4、事业单位 3、社会机构 2，共 50 家）；公开官网及官网直链第三方系统的只读、低并发访问范围已确认，不设固定开页次数上限，禁止登录、投递和绕过风控。具体企业名单和最低成功线待确认。H3 完成前禁止启动 T3 企业外网探测。
...
继续完成 H3：确认 T3 最低成功线，再按已确认配额形成具体 50 家企业名单。在 H3 获得明确授权前，不访问任何企业网站，不启动 T3。
